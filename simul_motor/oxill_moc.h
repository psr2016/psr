/****************************************************************************
** Meta object code from reading C++ file 'oxill.h'
**
...
#error "The header file 'oxill.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 13, 11), // "on_new_data"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 7), // "double*"
QT_MOC_LITERAL(4, 34, 1) // "p"

    },
    "Oscilloscope\0on_new_data\0\0double*\0p"
};
...
void Oscilloscope::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Oscilloscope *_t = static_cast<Oscilloscope *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_new_data((*reinterpret_cast< double*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject Oscilloscope::staticMetaObject = {
    { &QwtPlot::staticMetaObject, qt_meta_stringdata_Oscilloscope.data,
      qt_meta_data_Oscilloscope,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Oscilloscope::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Oscilloscope.stringdata0))
        return static_cast<void*>(const_cast< Oscilloscope*>(this));
